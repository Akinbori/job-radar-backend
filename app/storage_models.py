...
class OpportunityRecord(Base):
    ...
    contact_name: Mapped[str] = mapped_column(String(255), nullable=False, default="unknown")
    contact_title: Mapped[str] = mapped_column(String(255), nullable=False, default="unknown")
    contact_source: Mapped[str] = mapped_column(String(64), nullable=False, default="none")
    contact_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    outreach_status: Mapped[str] = mapped_column(String(64), nullable=False, default="apply_only")
